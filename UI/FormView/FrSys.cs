...
namespace UI
{
    public partial class FrSys : Form
    {
        ...
        {
            //CD_L1_HD_IN.Config(MT.CLD_DL_HD_HD1);
            //CD_L1_STP_IN.Config(COM.CD_L1_STP_IN);
            //CD_L1_STP_A.Config(COM.CD_L1_STP_A);
            //CD_L1_STP_B.Config(COM.CD_L1_STP_B);
            //CD_L1_STP_OUT.Config(COM.CD_L1_STP_OUT);
            //CD_L1_HD_OUT.Config(COM.CD_L1_HD_OUT);
            //CD_L1_PRE_LINK.Config(MT.GPIO_OUT_L1_PRE_OUT_EN,null,MT.GPIO_IN_L1_PRE_RDY);
            //CD_L1_NEXT_LINK.Config(MT.GPIO_OUT_L1_NEXT_IN_EN, null, MT.GPIO_IN_L1_NEXT_RDY);

            //CD_L2_HD_IN.Config(COM.CD_L2_HD_IN);
            //CD_L2_STP_IN.Config(COM.CD_L2_STP_IN);
            //CD_L2_STP_A.Config(COM.CD_L2_STP_A);
            //CD_L2_STP_B.Config(COM.CD_L2_STP_B);
            //CD_L2_STP_OUT.Config(COM.CD_L2_STP_OUT);
            //CD_L2_HD_OUT.Config(COM.CD_L2_HD_OUT);
            //CD_L2_PRE_LINK.Config(MT.GPIO_OUT_L2_PRE_OUT_EN, null, MT.GPIO_IN_L2_PRE_RDY);
            //CD_L2_NEXT_LINK.Config(MT.GPIO_OUT_L2_NEXT_IN_EN, null, MT.GPIO_IN_L2_NEXT_RDY);

            //CD_MOV_UD.Config(COM.CD_MOV_UD);
            //CD_MOV_HOLD.Config(COM.CD_MOV_HOLD);

            //axisConfig.AddAxis(MT.AxisList);
            //axisTable.AddAxis(MT.AxisList);
      ...
      public  void get_vs_parm()
        ...
        private void axisTable_Load(object sender, EventArgs e)
        {
        ...
        {
           switch( cTab_work.SelectedIndex)
           {
