...
namespace UI
{
    public partial class FrRst : Form
    {
        ...
        private void timer_update_Tick(object sender, EventArgs e)
        {
            ...
            //左取料
            //SetBtnStatusColor(btn_ws_get_x_sta, MT.AXIS_BOX_L_Y_FAF.home_status, bflag);
            //SetBtnStatusColor(btn_ws_get_y_sta, MT.AXIS_BOX_L_Y_NAF.home_status, bflag);
            //SetBtnStatusColor(btn_ws_get_a_sta, MT.AXIS_BOX_L_Z_NAF.home_status, bflag);
            //SetBtnStatusColor(btn_ws_get_z_sta, MT.AXIS_BOX_L_Z_DUST.home_status, bflag);

            //右光箱
            //SetBtnStatusColor(btn_lightbox_right_y_faf, MT.AXIS_BOX_R_Y_FAF.home_status, bflag);
            //SetBtnStatusColor(btn_lightbox_right_y_naf, MT.AXIS_BOX_R_Y_NAF.home_status, bflag);
            //SetBtnStatusColor(btn_lightbox_right_z_naf, MT.AXIS_BOX_R_Z_NAF.home_status, bflag);
            //SetBtnStatusColor(btn_lightbox_right_z_dust, MT.AXIS_BOX_R_Z_DUST.home_status, bflag);
            ...
            lb_wsGT.Text = string.Format("X: {0:000.000}  Y: {1:000.000}\nZ: {2:000.000}  A: {3:000.000}", COM.ws_get.axis_x.fcmd_pos, COM.ws_get.axis_y.fcmd_pos, COM.ws_get.axis_z.fcmd_pos, COM.ws_get.axis_a.fcmd_pos);
            lb_wsFD.Text = string.Format("X: {0:000.000}  Y: {1:000.000}\nZ: {2:000.000}  A: {3:000.000}", COM.ws_feed.axis_x.fcmd_pos, COM.ws_feed.axis_y.fcmd_pos, COM.ws_feed.axis_z.fcmd_pos, COM.ws_feed.axis_a.fcmd_pos);
            lb_wsBK.Text = string.Format("X: {0:000.000}  Y: {1:000.000}\nZ: {2:000.000}  A: {3:000.000}", COM.ws_back.axis_x.fcmd_pos, COM.ws_back.axis_y.fcmd_pos, COM.ws_back.axis_z.fcmd_pos, COM.ws_back.axis_a.fcmd_pos);
        //   lb_rightbox.Text = string.Format("Y1: {0:000.000}  Y2: {1:000.000}\nZ1: {2:000.000}  Z2: {3:000.000}", COM.RightLightBox.ax_y_faf.fcmd_pos, COM.RightLightBox.ax_y_naf.fcmd_pos, COM.RightLightBox.ax_z_dust.fcmd_pos, COM.RightLightBox.ax_z_naf.fcmd_pos);

          //  lb_dl.Text = string.Format("Y: {0:000.000}\nZ: {1:000.000}", DownloadModle.ax_y.fcmd_pos, DownloadModle.ax_z.fcmd_pos);
          //  lb_box_ok.Text = string.Format("X: {0:000.000}\nZ: {1:000.000}", COM.traybox_ok.ax_x.fcmd_pos, COM.traybox_ok.ax_z.fcmd_pos);
          //  lb_box_ng.Text = string.Format("X: {0:000.000}\nZ: {1:000.000}", COM.traybox_ng.ax_x.fcmd_pos, COM.traybox_ng.ax_z.fcmd_pos);

          //  lb_ul.Text = string.Format("X: {0:000.000}\nY: {1:000.000}\nZ: {2:000.000}\nU1: {3:000.000}\nU2: {4:000.000}", UploadModle.ax_x.fcmd_pos, UploadModle.ax_y.fcmd_pos, UploadModle.ax_z.fcmd_pos, UploadModle.axis_z1.fcmd_pos, UploadModle.axis_z2.fcmd_pos);
          //  lb_box_fd.Text = string.Format("X: {0:000.000}\nZ: {1:000.000}", COM.traybox_fd.ax_x.fcmd_pos, COM.traybox_fd.ax_z.fcmd_pos);

          //  lb_ws_1.Text = string.Format("F: {0:000.000}\nB: {1:000.000}\nU: {2:000.000}", COM.ws_back.axis_x.fcmd_pos, COM.ws_back.axis_y.fcmd_pos, COM.ws_back.axis_z.fcmd_pos);
          //  lb_ws_2.Text = string.Format("F: {0:000.000}\nB: {1:000.000}\nU: {2:000.000}", COM.ws_feed.axis_x.fcmd_pos, COM.ws_feed.axis_y.fcmd_pos, COM.ws_feed.axis_z.fcmd_pos);
          ////  lb_ws_3.Text = string.Format("F: {0:000.000}\nB: {1:000.000}\nU: {2:000.000}", COM.ws3.axis_x.fcmd_pos, COM.ws3.axis_y.fcmd_pos, COM.ws3.axis_z.fcmd_pos);

          //  lb_ws_5.Text = string.Format("F: {0:000.000}\nB: {1:000.000}\nU: {2:000.000}", COM.ws_get.axis_x.fcmd_pos, COM.ws_get.axis_y.fcmd_pos, COM.ws_get.axis_z.fcmd_pos);
          //  lb_tp.Text = string.Format("U: {0:000.000}", COM.ws_back.pos_idx * 90);
    
        }

       // private void btn_lightbox_left_home_Click(object sender, EventArgs e)
        //{
        //    if (StationGet.status == StationGet.EM_STA.HOME) return;
        ...
        //            EM_RES res = StationGet.Home(ref VAR.gsys_set.bquit);
        //            ShowMessage(string.Format("【{0}】 复位 {1}！", StationGet.disc, res == EM_RES.OK ? "成功" : "失败"), "提示", MessageBoxButtons.OK);
        //        }
        //        finally
        //        {
        ...
        //}
        private void btn_lightbox_right_home_Click(object sender, EventArgs e)
        {
            //if (COM.RightLightBox.status == LightBox.EM_STA.HOME) return;
            //if (DialogResult.OK != MessageBox.Show("确定要复位 【右光箱】？", "警告", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2)) return;
            ...
            //        ShowMessage(string.Format("【{0}】 复位 {1}！", COM.RightLightBox.disc, res == EM_RES.OK ? "成功" : "失败"), "提示", MessageBoxButtons.OK);
            //    }
            //    finally
            //    {
            //        Enablebtn(sender, true);
        ...
        private void ws_get_home_Click(object sender, EventArgs e)
        {
        ...
        private void ws_bull_back_home_Click(object sender, EventArgs e)
        {
            ...
            WsBuBK.home(ref VAR.gsys_set.bquit);
            //if (DialogResult.OK != MessageBox.Show("确定要复位 【弹夹收料工站】？", "警告", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2)) return;
            //Task task_home = new Task(() =>
            //{
            //    try
            ...
            //        Enablebtn(btn_all_home, false);
            //        VAR.gsys_set.bquit = false;
            //        EM_RES res = ws_bull.home_back(ref VAR.gsys_set.bquit);
            //        ShowMessage(string.Format("【{0}】 复位 {1}！", ws_bull.disc_fed, res == EM_RES.OK ? "成功" : "失败"), "提示", MessageBoxButtons.OK);
            //    }
            //    finally
            //    {
            //        Enablebtn(sender, true);
        ...
        {
            WSBack.home(ref VAR.gsys_set.bquit);
        }

        private void button37_Click(object sender, EventArgs e)
        {
            WSFeed.home(ref VAR.gsys_set.bquit);
        }
        ...
        {
            WSROLL.Home(ref VAR.gsys_set.bquit);
        }
        ...
        {
          // EM_RES ret=  WSGet.m_ActGet(ref  VAR.gsys_set.bquit);
        ...
        private void ws_move_get_Click(object sender, EventArgs e)
        {
        ...
        private void btn_ws_move_home_Click(object sender, EventArgs e)
        {
            ...
            WsTrayMove.home(ref VAR.gsys_set.bquit);
        }
