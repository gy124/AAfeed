...
{
    public delegate EM_RES Update_product();
    #region 基本结构
    public struct ST_XY
    {
        public double x;
    ...
    public class SYS_SET
    {
       ...
       public  Update_product UpdatePro;
        public int box_tray_cnt;
        //使能蜂鸣器
        public bool beep_en;
        //蜂鸣器时间
        public int beep_tmr;
        ...
        public void LoadSysCfg(string filename = "")
        {
            ...
            box_tray_cnt = inf.ReadInteger("PRODUCT_SET", "box_tray_cnt",0);
            //信息处理
        ...
        public void SaveSysCfg(string filename = "")
        {
            ...
            inf.WriteInteger("PRODUCT_SET", "box_tray_cnt", box_tray_cnt);
